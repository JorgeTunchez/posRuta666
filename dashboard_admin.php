...
$sql_empleados = "SELECT COUNT(*) as count FROM empleados";
$result = $conn->query($sql_empleados);
if ($result->num_rows > 0) {
    $row = $result->fetch_assoc();
    $empleados_activos = $row['count'];
}
...
<head>
    ...
    <title>Ruta 666 - Dashboard Administrador</title>
...
<body>
    ...
    <div class="content">
        ...
        <div class="stats-container">
            ...
            <div class="stat-card">
                <h3>Empleados</h3>
                <div class="stat-number"><?php echo $empleados_activos; ?></div>
                <p>Total de empleados activos</p>
            </div>
            <div class="stat-card">
